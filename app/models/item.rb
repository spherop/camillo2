class Item < ApplicationRecord
  ...
  ITEM_TYPES = :creative_action, :goal, :idea, :post, :project, :question, :next_step, :journal_page, :strength # { "creative_action" => 0, "goal" => 1, "idea" => 2, "next_step" => 3, "post" => 4, "project" => 5, "question"=> 6 }
